...
def build_table1() -> str:
    ...
    caption = (": **Table 1. The out-of-panel predictive advantage survives strength "
               ...
               "`operator_completion_stratified_3106.csv` (a single representative holdout, "
               "seed 0; margins are stable across 20 random holdouts, mean ± SD in "
               "`operator_completion_multiseed_3106.csv`). The margin is largest for weak "
